...
`eco.kafkamanager.core.clientConfig[property]` | Common Kafka [client properties](https://kafka.apache.org/20/documentation.html#adminclientconfigs), used to connect to cluster. |

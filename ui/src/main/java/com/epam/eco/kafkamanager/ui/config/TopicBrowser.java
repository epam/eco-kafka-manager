...
public class TopicBrowser {
    ...
    private List<Replacement> tombstoneGenerationReplacements;
    ...
    public List<Replacement> getTombstoneGenerationReplacements() {
        return tombstoneGenerationReplacements;
    }

    public void setTombstoneGenerationReplacements(List<Replacement> tombstoneGenerationReplacements) {
        this.tombstoneGenerationReplacements = tombstoneGenerationReplacements;
    }
}

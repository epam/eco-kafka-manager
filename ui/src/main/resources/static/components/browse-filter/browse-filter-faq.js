   ...
   const browserFilerFaq = '<div class="faq">\n' +
       ...
       '<ul> \n' +
           ...
           '<li><p>Filter operates on only a set of records, which KM managed to read for <b>given timeout</b>. Offsets of these records indicated in offset range table.  \n' +
               'If the set of record does not contain desired data, just press button ">" to search in a records with higher offsets. \n' +
               '</p> \n' +
           '</li> \n' +

           '<li><p>It also have ability to filter records across <b>header values</b>.</p></li> \n' +
               '<p>To apply filter across headers you should choose <b>"headers"</b> in a column list and use <b>"headerKey: headerValue"</b> notation.</p> \n' +
               '<p><b>"Equals"</b>, <b>"contains"</b>, <b>"startWith"</b>, <b>"like"</b> and <b>"not empty"</b> operation are supported</p>\n' +

           '<li><p>Operations <b>"exclude"</b> and <b>"only"</b> used only for tombstones appearence: </p></li> \n' +

...
`eco.kafkamanager.ui.topicBrowser.tombstoneGenerationReplacements[X].headerName` | | This section descrides replacement while tombstone generation. It is header name for substitution.                                                                                                                                                         |                                           |
`eco.kafkamanager.ui.topicBrowser.tombstoneGenerationReplacements[X].replacement` | | This section descrides replacement while tombstone generation. It is expression for value for substitution.                                                                                                                                               |                                           |

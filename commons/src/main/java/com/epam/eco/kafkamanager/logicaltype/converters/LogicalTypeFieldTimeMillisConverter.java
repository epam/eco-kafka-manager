...
import static com.epam.eco.kafkamanager.utils.DateTimeUtils.intToLocalTime;

/**
 * @author Mikhail_Vershkov
 */
public class LogicalTypeFieldTimeMillisConverter implements LogicalTypeFieldAvroConverter<Integer, LocalTime> {
    ...
    public LogicalTypeEnum getLocalType() {
        return LogicalTypeEnum.TIME_MILLIS;
    }

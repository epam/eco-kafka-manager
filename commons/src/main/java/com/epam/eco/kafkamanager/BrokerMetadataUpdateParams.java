 ...
 */
public class BrokerMetadataUpdateParams {

    private final int brokerId;
    private final String description;
    private final Map<String, Object> attributes;

    public BrokerMetadataUpdateParams(
    ...
    public boolean equals(Object obj) {
        ...
        BrokerMetadataUpdateParams that = (BrokerMetadataUpdateParams) obj;
        return
    ...
    @Override
    public int hashCode() {
        return Objects.hash(brokerId, description, attributes);
    }
    ...
    public static Builder builder() {
        return builder((BrokerMetadataUpdateParams)null);
    }

    public static Builder builder(BrokerMetadataUpdateParams origin) {
    ...
    public static BrokerMetadataUpdateParams fromJson(Map<String, ?> map) {
        Validate.notNull(map, "JSON map is null");

        return MapperUtils.convert(map, BrokerMetadataUpdateParams.class);
    }

    public static BrokerMetadataUpdateParams fromJson(String json) {
        Validate.notNull(json, "JSON is null");

        return MapperUtils.jsonToBean(json, BrokerMetadataUpdateParams.class);
    }
    ...
    public static class Builder {
        ...
        public BrokerMetadataUpdateParams build() {
            return new BrokerMetadataUpdateParams(brokerId, description, attributes);
        }
    }

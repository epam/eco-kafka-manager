 ...
 */
public class TopicSearchCriteriaImpl implements TopicSearchCriteria {

    private static final Logger LOGGER = LoggerFactory.getLogger(TopicSearchCriteriaImpl.class);
    ...
    public TopicSearchCriteriaImpl(
    ...
    public static Builder builder(TopicSearchCriteriaImpl origin) {
        return new Builder(origin);
    }

    public static TopicSearchCriteriaImpl fromJson(Map<String, ?> map) {
        Validate.notNull(map, "JSON map is null");

        return MapperUtils.convert(map, TopicSearchCriteriaImpl.class);
    }

    public static TopicSearchCriteriaImpl fromJson(String json) {
        Validate.notNull(json, "JSON is null");

        return MapperUtils.jsonToBean(json, TopicSearchCriteriaImpl.class);
    }

    public static TopicSearchCriteriaImpl fromJsonWith(Map<String, ?> map, KafkaManager kafkaManager) {
        TopicSearchCriteriaImpl topicSearchCriteria = fromJson(map);
    ...
    public static TopicSearchCriteriaImpl fromJsonWith(String json, KafkaManager kafkaManager) {
        TopicSearchCriteriaImpl topicSearchCriteria = fromJson(json);
        if (topicSearchCriteria == null) {
            return null;
        }
        return topicSearchCriteria.toBuilder()
    ...
    public static class Builder {
        ...
        private Builder(TopicSearchCriteriaImpl origin) {
            if (origin == null) {
                return;
            }
        ...
        public TopicSearchCriteriaImpl build() {
            return new TopicSearchCriteriaImpl(
                    topicName,
                    minPartitionCount,
                    maxPartitionCount,
                    minReplicationFactor,

 ...
 */
public class PermissionDeleteParams {
    ...
    private PermissionDeleteParams(
            ResourceType resourceType,
            String resourceName,
            String principal,
    ...
    public boolean equals(Object obj) {
        ...
        PermissionDeleteParams that = (PermissionDeleteParams) obj;
        return
    ...
    public static Builder builder(PermissionDeleteParams origin) {
    ...
    public static class Builder {
        ...
        private Builder(PermissionDeleteParams origin) {
            if (origin == null) {
                return;
            }
        ...
        public PermissionDeleteParams build() {
            return new PermissionDeleteParams(
                    resourceType,
                    resourceName,
                    principal,
                    principalObject,

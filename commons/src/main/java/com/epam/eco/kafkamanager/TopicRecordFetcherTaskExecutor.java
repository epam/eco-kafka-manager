...
public interface TopicRecordFetcherTaskExecutor<K, V> extends TaskExecutor<String, TopicRecordFetchParams, RecordFetchResult<K, V>> {
    ...
    @Override
    RecordFetchResult<K, V> execute(@P("resourceKey") String topicName, TopicRecordFetchParams request);

    @Override
    TaskResult<RecordFetchResult<K, V>> executeDetailed(@P("resourceKey") String topicName, TopicRecordFetchParams request);

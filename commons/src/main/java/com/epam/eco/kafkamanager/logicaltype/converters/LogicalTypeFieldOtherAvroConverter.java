 ...
 */
public class LogicalTypeFieldOtherAvroConverter implements LogicalTypeFieldAvroConverter<Object,Object> {

    @Override
    public Object convertInternal(
            Schema schema,
    ...
    public Schema.Type getType() {
        return Schema.Type.valueOf("NONE");
    }

...
import static com.epam.eco.kafkamanager.utils.DateTimeUtils.intDateToLocalDate;

/**
 * @author Mikhail_Vershkov
 */
public class LogicalTypeFieldIntDateConverter implements LogicalTypeFieldAvroConverter<Integer, LocalDate> {

    @Override
    public LocalDate convertInternal(
            Schema schema,
            @Nonnull Integer value
    ) {
        return intDateToLocalDate(value);
    }

 ...
 * @author Raman_Babich
 */
public class TopicPartitionsRequestTest {

    @Test
    public void testSerializedToJsonAndBack() throws Exception {
        TopicPartitionsRequest origin = new TopicPartitionsRequest(10);
        ...
        TopicPartitionsRequest deserialized = mapper.readValue(
                json,
                TopicPartitionsRequest.class);

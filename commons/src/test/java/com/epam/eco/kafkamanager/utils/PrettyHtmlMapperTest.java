...
public class PrettyHtmlMapperTest {
    ...
    private final static String CORRECT_HTML_RESULT = "{<br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.exclusions</b>\" = {<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"<b>exclusion_doc_id</b>\" = 433341, <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.exclusions.exclusions2</b>\" = {<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"<b>exclusion2_id</b>\" = \"2345686-24521-1342\", <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"<b>exclusion2_doc_id</b>\" = 433452341<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}, <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\"<b>exclusion_id</b>\" = \"UUID\"<br/>&nbsp;&nbsp;&nbsp;&nbsp;}, <br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.tt</b>\" = 1546149600.000000000, <br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.doc_id</b>\" = 4321, <br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.bt</b>\" = 1546149600.000000000, <br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.lsn</b>\" = 123454, <br/>&nbsp;&nbsp;&nbsp;&nbsp;\"<b>_datahub.metadata.operation_Id</b>\" = \"12345678\"<br/>}";
    private final static String CORRECT_JSON_RESULT = "{\n    \"_datahub.metadata.exclusions\" = {\n        \"exclusion_doc_id\" = 433341, \n        \"_datahub.metadata.exclusions.exclusions2\" = {\n            \"exclusion2_id\" = \"2345686-24521-1342\", \n            \"exclusion2_doc_id\" = 433452341\n        }, \n        \"exclusion_id\" = \"UUID\"\n    }, \n    \"_datahub.metadata.tt\" = 1546149600.000000000, \n    \"_datahub.metadata.doc_id\" = 4321, \n    \"_datahub.metadata.bt\" = 1546149600.000000000, \n    \"_datahub.metadata.lsn\" = 123454, \n    \"_datahub.metadata.operation_Id\" = \"12345678\"\n}";
    ...
    public void toPrettyHtmlTest() {
        String html = PrettyHtmlMapper.toPretty(generateMap(),PrettyHtmlMapper.PrettyFormat.HTML);
        assertEquals(CORRECT_HTML_RESULT, html);
    }

    @Test
    public void toPrettyUtf8HtmlTest() {
        String html = PrettyHtmlMapper.toPretty(generateUtf8Map(), PrettyHtmlMapper.PrettyFormat.HTML);
        assertEquals(CORRECT_HTML_RESULT, html);
    }

    @Test
    public void toPrettyJsonTest() {
        String json = PrettyHtmlMapper.toPretty(generateMap(),PrettyHtmlMapper.PrettyFormat.JSON);
        assertEquals(CORRECT_JSON_RESULT, json);
    }

    @Test
    public void toPrettyUtf8JsonTest() {
        String json = PrettyHtmlMapper.toPretty(generateUtf8Map(), PrettyHtmlMapper.PrettyFormat.JSON);
        assertEquals(CORRECT_JSON_RESULT, json);
    }

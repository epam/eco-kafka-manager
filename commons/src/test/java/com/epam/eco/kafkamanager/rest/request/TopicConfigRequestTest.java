 ...
 * @author Raman_Babich
 */
public class TopicConfigRequestTest {

    @Test
    public void testSerializedToJsonAndBack() throws Exception {
        TopicConfigRequest origin = new TopicConfigRequest(Collections.singletonMap("a", "a"));
        ...
        TopicConfigRequest deserialized = mapper.readValue(
                json,
                TopicConfigRequest.class);
